...
This is a simple weather app. You can view the weather either by typing city name or by using own current location (make sure to give location perms). 
...
Backend server with Node.js and express handling OpenWeather API requests
